...
import TypeTable from '@/components/hooks/admin/product/type/TypeTable';

import Pagination from '@/components/hooks/admin/product/type/Pagination';
...
export default function TypeManager() {
    ...
    const { types, addType, deleteType } = useTypes(selectedCategory, newType, setNewType);
    ...
    return (
        <section className='type-manager'>
            <div className="type__container container">
                ...
                <button onClick={addType} className='add-type'>Add Type</button>
